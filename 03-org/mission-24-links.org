...
- The file 'mission-23-tables.org'.
...
1) Using links:
   ...
   * ORDERS
     ...
     - Press C-u C-c C-l, the text 'File: ~/emacs-bootcamp/03-org/' is
       ...
       '~/emacs-bootcamp/03-org/mission-23-tables.org' and press RET.

     - As before Emacs will ask you for a description for the link, type
       the text 'mission-23' and press RET, the link is inserted.
     ...
     - Press <BACKSPACE> just ONE time to delete the last ']' character of
       the link, the text '[[file:mission-23-tables.org][mission-23]' is
     ...
     - Press C-a to go to the beggining of that line and press C-x C-o to
       ...
       'mission-23-tables.org' file.  This command will save the current
...
1) Storing links:
   ...
   * ORDERS
     ...
     - Press C-x C-f and visit the 'mission-23-tables.org' file.

     - When the buffer is opened, press C-c l, the text
       'Stored: file: ~/emacs-bootcamp/03-org/mission-23-tables.org' is
       displayed.
     ...
     - As always Emacs ask you for a link description, write the text
       'mission-23' and press RET, the link gets inserted.
