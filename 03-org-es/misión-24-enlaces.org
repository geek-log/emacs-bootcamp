...
- El archivo 'misión-23-tablas.org'.
...
1) Usando enlaces:
   ...
   * ÓRDENES
     ...
     - Presione C-u C- C-l, el texto 'Archivo: ~/emacs-bootcamp/03-org-es/'
       ...
       '~/emacs-bootcamp/03-org-es/misión-23-tablas.org' y presione RET.

     - Igual que antes Emacs te preguntará por una descripción para el
       enlace, digite el texto 'misión-23' y presione RET, el enlace es
       insertado.
     ...
     - Presione <BACKSPACE> solo UNA vez para borrar el último caracter ']'
       del enlace, el texto '[[file:misión-23-tablas.org][misión-23]' se
     ...
     - Presione C-a para ir al principio de esa línea y presion C-x C-o para
       ...
       'misión-23-tablas.org'. Este comando guardará la posición actual
...
1) Almacenando enlaces:
   ...
   * ÓRDENES
     ...
     - Presione C-x C-f y visite el archivo 'misión-23-tablas.org'.

     - Cuando el buffer se abre, presione C-c l, se despliega el texto
       'Almacenado: archivo: ~/emacs-bootcamp/03-org-es/misión-23-tables.org'
     ...
     - Como siempre Emacs te pregunta por una descripción para el enlace,
       digite el texto 'misión-23' y presione RET, el enlace es insertado.
